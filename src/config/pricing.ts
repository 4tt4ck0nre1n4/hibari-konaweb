...
const PRICING_ITEMS_RAW = [
  ...
  },
  {
    ...
    isQuantifiable: false,
    icon: "fxemoji:pages",
    iconClass: "icon-landing",
  },
  {
    id: "top-responsive",
    name: "トップページ レスポンシブ対応",
    basePrice: 0,
    isQuantifiable: false,
    icon: "flat-color-icons:smartphone-tablet",
    iconClass: "icon-resp-top",
  },
  {
    id: "sub-responsive",
    name: "下層ページ レスポンシブ対応",
    ...
    isQuantifiable: true,
    icon: "flat-color-icons:smartphone-tablet",
    iconClass: "icon-resp-sub",
  },
  {
    id: "landing-responsive",
    name: "ランディングページ レスポンシブ対応",
    basePrice: 5000,
    isQuantifiable: false,
    icon: "flat-color-icons:smartphone-tablet",
    iconClass: "icon-resp-lp",
  },
  {
    id: "wordpress-setup",
    name: "WordPress 環境構築",
    basePrice: 15000,
    isQuantifiable: false,
    icon: "material-icon-theme:folder-wordpress-open",
  },
  {
    id: "wordpress-theme",
    name: "WordPress オリジナルテーマ制作",
    basePrice: 30000,
    isQuantifiable: false,
    icon: "material-icon-theme:folder-wordpress-open",
    iconClass: "icon-wp-theme",
  },
  {
    id: "wordpress-custom-field",
    name: "WordPress カスタムフィールド",
    basePrice: 10000,
    isQuantifiable: false,
    icon: "material-icon-theme:folder-wordpress-open",
    iconClass: "icon-wp-field",
  },
  {
    id: "fade-animation",
    name: "フェードインアニメーション",
  ...
  },
  {
    ...
    iconClass: "icon-other-animation",
  },
  {
    id: "headless-cms",
    name: "ヘッドレスCMS",
  ...
  },
  {
    ...
    basePrice: 10000,
    isQuantifiable: false,
    icon: "streamline-kameleon-color:newspaper",
  },
  {
    id: "other-functions",
    name: "その他の機能",
...
export const PRICING_ITEMS: PricingItem[] = validateConfigData(pricingItemsSchema, PRICING_ITEMS_RAW, "PRICING_ITEMS");
...
export const PLANS: Plan[] = validateConfigData(plansSchema, PLANS_RAW, "PLANS");

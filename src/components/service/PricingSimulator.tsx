...
import { PricingSimulatorScrollBar } from "@/components/service/PricingSimulatorScrollBar";
import IconifyInline from "@/components/ui/IconifyInline";
import { mail } from "@/config/ui";
import {
  PRICING_ITEMS,
...
import { calculatePrice, calculatePagePrice } from "@/pricing/calculatePrice";
import { saveState, loadState, clearState } from "@/pricing/storageManager";
import { generateEstimateNumber, formatDateForDisplay, calculateExpiryDate } from "@/pricing/generateEstimateNumber";
